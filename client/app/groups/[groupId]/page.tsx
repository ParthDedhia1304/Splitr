      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4">
            <button onClick={() => router.push('/dashboard')} className="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-slate-900 text-slate-500 hover:text-indigo-600 shadow-sm border border-slate-200 dark:border-slate-800 transition-all">←</button>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            {/* WRAPPER FIX: Keeps Form and Debts sticky together */}
            <div className="sticky top-4 space-y-6">
              ...
              <motion.div 
                ...
                className="bg-slate-900 dark:bg-black text-slate-100 p-6 rounded-2xl shadow-lg ring-1 ring-slate-800"
              >
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* --- NEW CHART COMPONENT --- */}
            <SpendingChart expenses={expenses} members={group.members} />
                   ...
                   expenses.map((exp, i) => {
                      ...
                      return (
                        <motion.div 
                          ...
                          transition={{ delay: 0.1 * i }} // Staggered animation
                          className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-md dark:hover:border-slate-700 transition-all flex items-center justify-between group"
                        >
                          <div className="flex items-center gap-4">
